...
Atualizado em 11/09/2026. Este documento descreve a release que ainda está no
...
1. Rodar, nesta ordem, no SQL Editor do Supabase de Produção:
   - `supabase/migrations/202609100011_launch_recovery_and_reactivation.sql`;
   - `supabase/migrations/202609100012_first_party_product_metrics.sql`.
...
5. Confirmar no Asaas de Produção que o webhook
   ...
   de checkout, pagamento e assinatura documentados no `SETUP.md`.
...
6. Programe o cancelamento. Confirme no Asaas o estado `INACTIVE`, no painel a
   data final de acesso e na loja pública a continuidade do acesso.
