...
<div style="max-width:560px;margin:0 auto;padding:32px 20px">
  <div style="background:#fff;border:1px solid #d9e2dd;border-radius:16px;padding:28px">
    ...
    <h1 style="font-size:24px;line-height:1.25;margin:0 0 12px">Continue seu cadastro</h1>
    <p style="font-size:16px;line-height:1.6;margin:0 0 24px">Use o botão abaixo para retomar com segurança o cadastro relacionado a este e-mail.</p>
    <a href="${safeLink}" style="display:inline-block;background:#174f3d;color:#fff;text-decoration:none;font-weight:700;padding:14px 20px;border-radius:10px">Recuperar meu cadastro</a>
